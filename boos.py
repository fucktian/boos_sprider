...
class writeExcel:
    ...
    def wE_r(self):
        ...
        new_workbook.save('jobBossmid.xlsx')
        new_workbook.close()
        app.quit()
...
if __name__ == '__main__':
    ...
    url = 'https://www.zhipin.com/c101020100/y_6/?query=%E7%89%A9%E6%B5%81%E8%BF%90%E8%90%A5&ka=sel-salary-6'

    for i in range(10):  # +str(i);key=
        try:
            print(str(i), '获取第{}页数据'.format(i + 1))
            url = 'https://www.zhipin.com/c101020100/y_' + salary + '/?query=' + key + '&city=101210100&industry=&position=&ka=sel-salary-' + salary + '&page=' + str(
                i + 1) + '&ka=page-' + str(i + 1)
            print(url)
